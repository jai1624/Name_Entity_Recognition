...
tokenizer = AutoTokenizer.from_pretrained("/bio_medical_ner/Fashion-Brand/model", model_max_length=128)
model = AutoModelForTokenClassification.from_pretrained("/bio_medical_ner/Fashion-Brand/model")
...
def main():
    ...
    interface.launch(server_name="0.0.0.0", server_port=7002)
